...
(function (G) {
  ...
  function drawGas() {
    ...
    el("gas-legend").innerHTML =
      ...
      '<span>روزهای اوج مصرف از ۱۴۰ میلیون لیتر در روز نیز گذشته است</span>';
  }
  ...
  function updatePeriDetail() {
    ...
    box.innerHTML =
      ...
      '<span class="row">رشد سطح ساخته‌شده (۱۳۸۹–۱۳۹۹): <b>' + gTxt + "</b></span>" +
  ...
  function drawPeriMap() {
    ...
    el("peri-note").textContent =
      "تهران و کرج دو مرکز اصلیِ منطقه‌اند (با حلقهٔ طلایی مشخص شده‌اند)؛ شهرهای اطراف، دایرهٔ رشدِ خود را دارند. اندازه دایره = رشد سطح ساخته‌شده ۱۳۸۹–۱۳۹۹ (پژوهش منطقه کلان‌شهری تهران). پرند، شهر جدیدی درون شهرستان رباط‌کریم است؛ رقم ۱۳۸.۵٪ رشدِ کل شهرستان است که ساخت‌وساز پرند را هم در بر می‌گیرد. دو الگوی دسترسی دیده می‌شود: شهرهای روی خط ریلی (پرند، پاکدشت، پیشوا، ری) در برابر شهرهای وابسته به اتوبوس و خودرو (پردیس، شهریار). منبع دسترسی: گزارش‌های خطوط حومه‌ای، ۱۴۰۴.";
    updatePeriDetail();
  }
